        ...
        <div class="container-fluid">
            ...
            <div class="menu_main">
                <ul>
                    ...
                    <%--                     <li><a href="savollar.jsp">Savollar</a></li>--%>
        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="container">
                        <h1 class="banner_taital">Internet</h1>
                        <p class="banner_text">Internetga qaramlik oddiy xolatmi yoki unga qandaydir jiddiy kasallik
                            holida qarash kerakmi?</p>
                        <div class="read_bt"><a href="/questions">Savollarni boshlash</a></div>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="container">
                        <h1 class="banner_taital">Ijtimoiy tarmoqlar</h1>
                        <p class="banner_text">Odamlar ijtimoiy tarmoqsiz hayot yo'q deyayotgan vaqtda, ajdodlarimiz
                            ularsiz bizdan ko'ra yaxshi yashaganini unutish to'g'rimi?</p>
                        <div class="read_bt"><a href="savollar.jsp">Savollarni boshlash</a></div>
                    </div>
                </div>
