        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="container">
                        <h1 class="banner_taital">Natijangiz:</h1>
                        <p class="banner_text">
                        ...
                        %>
                            ...
                            %></h1></p>
                        <div class="read_bt"><a href="/questions">Savollarni qayta boshlash</a></div>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="container">
                        ...
                        %>
                            ...
                            %></h1> </p>
                        <div class="read_bt"><a href="savollar.jsp">Savollarni qayta boshlash</a></div>
                    </div>
                </div>
